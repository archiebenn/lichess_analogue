...
The aim was to have a message printed and the LED strip to light up when a magnet is near the hall effect sensor (mimicking a magnet within a chess piece on a specific square).  
